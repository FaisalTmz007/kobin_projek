    ...
    <div class="card w-50">
        ...
        <div class="mt-2 card-body d-flex flex-column justify-content-around align-items-center">
            <div class="w-100 mt-4">
                ...
                <input class="form-control" name="tanggal" type="date" value="" aria-label="Disabled input example">
            </div>
            
                <div class="w-100 mt-2">
                    <label for="jumlah_masuk" class="mb-3 fw-bold">Jumlah Pemasukan</label>
                    <input class="form-control" name="jumlah_masuk" type="number" value="" aria-label="Disabled input example">
                </div>
                <div class="w-100 mt-2">
                    <label for="jumlah_keluar" class="mb-3 fw-bold">Jumlah Pengeluaran</label>
                    <input class="form-control" name="jumlah_keluar" type="number" value="" aria-label="Disabled input example">
                </div>
                <div class="w-100 mt-2 mb-4">
                    <label for="keterangan" class="mb-3 fw-bold">Keterangan</label>
                    <input class="form-control" name="keterangan" type="text" value="" aria-label="Disabled input example">
                </div>
            </div>
